...
def pureText(text):
    ...
    text=re.sub('[^A-Z a-z 0-9 äöüÄÖÜß]+','', text) # Remove all Punctiations or Special Charactors 
...
def NLP_Pipeline(df, sentiment=False, language="en",column="text"):
    ...
    print("Words Count & letters Count done.")
   # df["word_count"]=df.text_clean.apply(lambda x: len(x.split()))
    print("Words Count & letters Count done. next: langauage detection.")
